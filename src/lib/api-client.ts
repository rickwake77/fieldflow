...
export const api = {
  ...
  createInvoice: (data: { customerId: number; jobIds: number[]; dueInDays?: number; extraItems?: Array<{ description: string; quantity: number; unitPrice: number; vatApplicable: boolean }> }) =>
